...
```mermaid
graph TD
    A[🏛️ NIVEAU 1 : CONSTITUTION & LOI FONDAMENTALE<br/>docs/feuille-de-route.md] --> B[📑 NIVEAU 2 : CAHIER DES CHARGES & DOCUMENT D'APPLICATION<br/>00-cahier-des-charges/cahier-des-charges-600jours-v1.0.md]
    B --> C[🧩 NIVEAU 3 : COMPOSANTS, LOGICIEL, CODE JS & CONTENUS<br/>mkdocs.yml, docs/js/*, docs/tome-p*/*, Espaces UI]
```
