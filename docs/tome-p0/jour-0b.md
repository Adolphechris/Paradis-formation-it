...
## 🎯 Objectifs du Jour
Comprendre le système binaire, la différence entre un bit et un octet, et les unités de mesure de données (Ko, Mo, Go, To).

---

## 🖼️ Illustrations & Découverte Visuelle
![La Logique Binaire : Pourquoi tout est 0 et 1 ?](https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800)

---

## 📖 1. Concepts Clés & Définitions

- 🔹 **Le Bit (0 ou 1)**\n- 🔹 **L'Octet (8 bits)**\n- 🔹 **Unités de Stockage (Ko, Mo, Go, To)**\n- 🔹 **Codage ASCII & Unicode**
