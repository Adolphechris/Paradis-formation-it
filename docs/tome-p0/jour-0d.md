...
## 🎯 Objectifs du Jour
Découvrir le fonctionnement d'Internet, la différence entre réseau local (LAN) et réseau étendu (WAN), et la notion d'adresse IP.

---

## 🖼️ Illustrations & Découverte Visuelle
![Le Monde du Réseau & d'Internet](https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800)
