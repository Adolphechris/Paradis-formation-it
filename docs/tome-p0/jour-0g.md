...
## 🎯 Objectifs du Jour
Comprendre la logique d'exécution d'un programme, la différence entre langage compilé (C/C++) et interprété (Python/Bash).

---

## 🖼️ Illustrations & Découverte Visuelle
![Comment Fonctionne un Programme Informatique ?](https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800)

---

## 📖 1. Concepts Clés & Définitions

- 🔹 **Qu'est-ce qu'un Algorithme ?**\n- 🔹 **Code Source vs Code Binaire**\n- 🔹 **Langages Compilés (C/Go)**\n- 🔹 **Langages Interprétés (Python/Bash)**
