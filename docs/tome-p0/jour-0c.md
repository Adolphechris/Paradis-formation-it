...
## 🎯 Objectifs du Jour
Différencier le matériel, le noyau (Kernel), le système d'exploitation (Windows/Linux/macOS) et les logiciels d'application.

---

## 🖼️ Illustrations & Découverte Visuelle
![Système d'Exploitation (OS) vs Applications](https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?w=800)

---

## 📖 1. Concepts Clés & Définitions

- 🔹 **Rôle de l'OS**\n- 🔹 **Le Noyau (Kernel)**\n- 🔹 **Interface Graphique (GUI) vs Ligne de commande (CLI)**\n- 🔹 **Logiciels Applicatifs**
